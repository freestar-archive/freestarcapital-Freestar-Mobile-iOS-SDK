...
//        applyTargeting()
    ...
    func applyTargeting() {
        PBTargetingParams.sharedInstance().age = 25;
        PBTargetingParams.sharedInstance().gender = PBTargetingParamsGender.female;
        PBTargetingParams.sharedInstance().setCustomTargeting("country", withValues: ["united states"])
        PBTargetingParams.sharedInstance().setCustomTargeting("race", withValues: ["asian", "hispanic"])
    }
