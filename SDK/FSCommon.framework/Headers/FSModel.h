...
typedef enum : NSUInteger {
    FSPropertyStorageNone,
    FSPropertyStorageTransitory,
    FSPropertyStoragePermanent,
} FSPropertyStorage;
...
@protocol FSModel <NSObject, NSCopying>
...
- (void)mergeValueForKey:(NSString *)key fromModel:(id<FSModel>)model;
...
@interface FSModel : NSObject <FSModel>
