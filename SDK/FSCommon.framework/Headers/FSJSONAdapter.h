...
extern NSString * const FSJSONAdapterErrorDomain;

/// +classForParsingJSONDictionary: returned nil for the given dictionary.
extern const NSInteger FSJSONAdapterErrorNoClassFound;

/// The provided JSONDictionary is not valid.
extern const NSInteger FSJSONAdapterErrorInvalidJSONDictionary;

/// The model's implementation of +JSONKeyPathsByPropertyKey included a key which
/// does not actually exist in +propertyKeys.
extern const NSInteger FSJSONAdapterErrorInvalidJSONMapping;

/// An exception was thrown and caught.
extern const NSInteger FSJSONAdapterErrorExceptionThrown;

/// Associated with the NSException that was caught.
extern NSString * const FSJSONAdapterThrownExceptionErrorKey;

/// Converts a MTLModel object to and from a JSON dictionary.
@interface FSJSONAdapter : NSObject
...
@interface FSJSONAdapter (ValueTransformers)
