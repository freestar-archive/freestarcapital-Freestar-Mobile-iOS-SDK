...
typedef enum : NSUInteger {
    FSModelEncodingBehaviorExcluded = 0,
    FSModelEncodingBehaviorUnconditional,
    FSModelEncodingBehaviorConditional,
} FSModelEncodingBehavior;

/// Implements default archiving and unarchiving behaviors for MTLModel.
@interface FSModel (NSCoding) <NSCoding>
...
@interface FSModel (OldArchiveSupport)
