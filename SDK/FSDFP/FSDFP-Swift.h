...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FSDFP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL_NAMED("FSAdObject")
...
- (void)load:(GADRequest * _Nullable)request;
@end


/// Protocol that defines a banner.
SWIFT_PROTOCOL_NAMED("FSBanner")
...
SWIFT_CLASS_NAMED("FSDFPInterstitial")
...
- (nonnull instancetype)initWithEventHandler:(void (^ _Nullable)(NSString * _Nonnull, NSDictionary<NSString *, id> * _Nonnull))eventHandler adUnitId:(NSString * _Nonnull)adUnitId;
- (void)loadRequest:(GADRequest * _Nullable)request;
...
SWIFT_PROTOCOL_NAMED("FSInterstitial")
...
SWIFT_PROTOCOL_NAMED("FSRegistrationDelegate")
...
SWIFT_CLASS("_TtC5FSDFP5Utils")
@interface Utils : NSObject
/// The initializer that needs to be created only once
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)removeHBKeywordsWithRequest:(DFPRequest * _Nullable)request;
@end
