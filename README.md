...
| ---- | ------- | ----------- |
| __0.6.9__ | _June 29th, 2020_ |  • [GMA SDK 7.61.0 compatibility](#gma-sdk-compatibility-matrix).<br> • Removed usage of UIWebView (deprecated).|
...
| ---- | ----- | -- | ------------ |
| ~> 0.6.9 | 7.61.0 | :ballot_box_with_check: | pod 'Google-Mobile-Ads-SDK', '7.61.0' |
