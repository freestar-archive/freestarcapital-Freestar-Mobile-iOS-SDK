Pod::Spec.new do |s|
  ...
  s.subspec 'Mediation' do |mediation|
    mediation.subspec 'MoPub' do |mopub|
       ...
       mopub.dependency 'mopub-ios-sdk/Core', '5.11.0'
       mopub.dependency 'Google-Mobile-Ads-SDK', '7.61.0'
    end
    ...
    mediation.subspec 'Facebook' do |facebook|
       ...
       facebook.dependency 'FBAudienceNetwork', '5.6.1'
       facebook.dependency 'Google-Mobile-Ads-SDK', '7.61.0'
    end
  end
